...
vector<string> temp1 = {"Auto", "double", "int", "struct", "Break", "else", "long", "switch",
"Case", "enum", "register", "typedef", "Char", "extern", "return", "union", "Const", "float",
"short", "unsigned", "Continue", "for",
"signed", "void", "Default", "goto", "sizeof", "volatile", "Do", "if", "static", "while", "Asm",
"dynamic_cast", "namespace", "reinterpret_cast", "Bool", "explicit", "new", "static_cast",
"Catch false", "operator", "template", "Class", "friend", "private", "this", "Const_cast", "inline",
"public", "throw", "Delete", "mutable", "protected", "true", "Try", "typeid", "typename", "using",
"virtual", "wchar_t"};
...
int main(){
fstream fptr;
fptr.open("sample code.txt", ios::in);
...
buffer += line[i++];
while(i<line.size()&&line[i]>='0'&&line[i]<='9') buffer += line[i++]; cout<<"integer
